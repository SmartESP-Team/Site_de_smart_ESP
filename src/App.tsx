...
const HomePage = () => {
  ...
  // Afficher le popup après 3 secondes si l'utilisateur n'a pas encore soumis ses informations
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white scroll-smooth">
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-[100]">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl border-2 border-blue-200 relative overflow-hidden">
            {/* Animation "robot" */}
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-500 to-purple-500 animate-pulse"></div>
            <div className="absolute -top-4 -left-4 w-16 h-16 rounded-full bg-blue-100 border-4 border-blue-300 flex items-center justify-center">
              <Cpu className="text-blue-600" size={24} />
            </div>
            <div className="absolute -top-2 -right-2 w-12 h-12 rounded-full bg-purple-100 border-4 border-purple-300 flex items-center justify-center">
              <Wifi className="text-purple-600" size={20} />
            </div>

            {/* Contenu du popup */}
            <div className="text-center mb-6 mt-4">
              <h2 className="text-2xl font-bold text-gray-800">🤖 Bienvenue sur votre plateforme IoT !</h2>
              <p className="text-gray-600 mt-3">
                Vous êtes un <strong>robot connecté</strong> !<br />
                Partagez votre <strong>email</strong> ou <strong>numéro de téléphone</strong> pour rester en contact.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <input
                type="email"
                placeholder="Votre email (ex: user@example.com)"
            ...
            <div className="mt-6 flex justify-center space-x-4">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-70 transition-all flex items-center space-x-2"
              >
                {isSubmitting ? (
                  <>
