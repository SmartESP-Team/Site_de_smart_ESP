...
const ComponentsPage = ({ setCurrentPage, selectedComponent, setSelectedComponent }: {
  ...
  const [chatMessages, setChatMessages] = useState<{ role: string; content: string }[]>([
    {
      role: 'assistant',
      content: "Bonjour ! Je suis votre assistant IoT. Demandez-moi quels composants vous avez besoin pour votre projet (ex: 'Quels composants pour un jardin intelligent ?').",
    },
  ]);
    ...
    <div className="max-w-3xl mx-auto text-center">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-blue-100 mb-8 text-left max-w-2xl mx-auto">
        ...
        <ul className="space-y-3 text-gray-600">
          <li className="flex items-start space-x-3"><Zap className="text-blue-500 mt-1 flex-shrink-0" size={16} /><span>Retournez à l'accueil pour explorer les fonctionnalités.</span></li>
          <li className="flex items-start space-x-3"><Zap className="text-blue-500 mt-1 flex-shrink-0" size={16} /><span>Parcourez le catalogue de composants IoT pour vos projets.</span></li>
          <li className="flex items-start space-x-3"><Download className="text-blue-500 mt-1 flex-shrink-0" size={16} /><span>Téléchargez l'application Smart ESP pour commencer.</span></li>
        </ul>
      </div>
